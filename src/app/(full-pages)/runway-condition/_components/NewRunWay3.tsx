...
const NewRunWay3 = () => {
  ...
  const SurfaceConditionsData = useQuery({
    queryFn: () => GetSurfaceCondition(),
    queryKey: ["surface-cconditions"],
  });
    ...
    <div className="flex flex-col items-center">
      <div className="mb-4 flex flex-col items-center gap-4">
        ...
        <div className="flex gap-2">
          <div
            onClick={() => setValue(0)}
            className={`rounded-md border ${value === 0 && "border-[#3C50E0]"} flex max-w-[400px] cursor-pointer flex-col gap-2 p-2`}
          >
          ...
          <div
            onClick={() => setValue(1)}
            className={`rounded-md border ${value === 1 && "border-[#3C50E0]"} flex max-w-[400px] cursor-pointer flex-col p-2`}
          >
            <div className="flex items-center gap-2">
            ...
            <div>
              RWYCC – 6 для данной трети Сообщите о загрязнении с 25% зоной
              покрытия
            </div>
          </div>
          <div
            onClick={() => setValue(2)}
            className={`rounded-md border ${value === 2 && "border-[#3C50E0]"} flex max-w-[400px] cursor-pointer flex-col p-2`}
          >
            <div className="flex items-center gap-2">
            ...
            <div>
              Присвоить RWYCC на основе присутствия загрязняющих веществ и
              температуры
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-3 gap-2">
        <div className="rounded-md border border-primary p-2">
          ...
          <div className="flex gap-2">
            ...
            />
            <div className="">
              {val1 !== 6 && <InputNumber size="large" placeholder="Глубина" />}
            </div>
            {val1 !== 6 && (
              <Select
                size="large"
                ...
                onSelect={(val) => setSel1(val as number)}
                options={
                  SurfaceConditionsData.data?.data.map((item) => ({
                    value: item,
                    label: item,
                  })) || []
                }
        ...
        <div className="rounded-md border border-primary p-2">
          ...
          <div className="flex gap-2">
            ...
            />
            <div className="">
              {val2 !== 6 && <InputNumber size="large" placeholder="Глубина" />}
            </div>
            {val2 !== 6 && (
              <Select
                size="large"
                placeholder="Cостояние"
                onSelect={(val) => setSel2(val as number)}
                options={
                  SurfaceConditionsData.data?.data.map((item) => ({
                    value: item,
        ...
        <div className="rounded-md border border-primary p-2">
          ...
          <div className="flex gap-2">
            ...
            />
            <div className="">
              {val3 !== 6 && <InputNumber size="large" placeholder="Глубина" />}
            </div>
            {val3 !== 6 && (
              <Select
                size="large"
